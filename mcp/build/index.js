...
class XenCRMServer {
                        ...
                        inputSchema: {
                            ...
                            properties: {
                                limit: {
                                    ...
                                    minimum: 1,
                                    maximum: 10,
                                    description: 'Maximum number of campaigns to return (optional, defaults to 10)',
                                },
                            },
                        },
                    },
        ...
        const campaignsList = campaigns
            ...
            return [
                ...
                stats
                    ...
                    : '',
                delivery
                    ? `   • **Messages:** ${delivery.total_messages || 0} total, ${delivery.delivered_count || 0} delivered, ${delivery.failed_count || 0} failed`
                    : '',
                `   • **Created:** ${formatDate(campaign.created_at)}`,
    ...
    async start() {
        try {
            ...
            console.error('📊 Available tools: add_customer, add_order, create_campaign, list_segments, list_campaigns, get_campaign_stats');
